...
public class PaymentOrder {
    ...
    private static class PayeeInfo {
        private String payeeId;
        private String payeeReferece;
        ...
        public String getPayeeReferece() {
            return payeeReferece;
        }

        public void setPayeeReferece(String payeeReferece) {
            this.payeeReferece = payeeReferece;
        }
    ...
    private static class RiskIndicator {
