...
const expandResource = require('./expand.js');
...
module.exports.route = async (req, res) => {
    try {
        ...
        // to get the tokens you need to expand the /paid resource of the payment. This is just a specialized version of expand.
